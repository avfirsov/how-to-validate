...
<template>
  <div class="form">
    <div class="field">
      ...
      <p class="help is-danger" v-else-if="proxy$v.name.$error && !proxy$v.name.alpha">Name should consist only of letters</p>
    </div>
    ...
    <div class="field">
      ...
      <p class="help is-danger" v-if="proxy$v.username.$error && !proxy$v.username.required">Please, fill in the username</p>
    ...
    <div class="field">
      ...
      <p class="help is-danger" v-else-if="proxy$v.email.$error && !proxy$v.email.email">Please, enter a correct email</p>
    </div>
